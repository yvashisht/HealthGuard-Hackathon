...
with_node \
  ...
  --target "/Users/yajurvashisht/Documents/GitHub/HealthGuard-Hackathon/ios/Pods/Target Support Files/Pods-HealthGuard/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-constants" "expo-crypto" "expo-file-system" "expo-keep-awake" "expo-random" "expo-secure-store" "expo-web-browser"
